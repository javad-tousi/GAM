...
namespace GAM.Forms.Reports.Queries
{
    class Module_24
    {
        public static DataSet Fill(DataTable tblMaster, string[] dates, QueryProperties properties)
        {
            ...
            bands.Add(gvm.CreateBand("Facility", "اطلاعات قرارداد"));
            ...
            customersTable.Columns.Add(new DataColumn { ColumnName = "Facility.ContractId", Caption = "ش.قرارداد", DataType = Type.GetType("System.String") });
            customersTable.Columns.Add(new DataColumn { ColumnName = "Facility.Id", Caption = "کد", DataType = Type.GetType("System.Int32") });
            ...
            customersTable.Columns.Add(new DataColumn { ColumnName = "TotalPay.ContractDate", Caption = "تاریخ اعطاء", DataType = Type.GetType("System.String") });
            customersTable.Columns.Add(new DataColumn { ColumnName = "TotalPay.ContractAmount", Caption = "مبلغ اعطایی", DataType = Type.GetType("System.Double") });
            ...
            var SelectedCustomers = tblMaster.AsEnumerable().OrderByDescending(x => Numeral.AnyToDouble(x["ContractPayCost"]))
                               .Select(r => new
                               {
                                   ...
                                   ContractDate = r["ContractRegDate"],
                                   ContractAmount = Numeral.AnyToDouble(r["ContractPayCost"]),
                                   FacilityId = Numeral.AnyToInt32(r["FacilityID"].ToString()),
            ...
            foreach (var g in SelectedCustomers)
            {
                ...
                newRow["Facility.ContractId"] = g.ContractId;
                newRow["Facility.Id"] = g.FacilityId;
                newRow["Facility.Name"] = g.FacilityName;
                newRow["TotalPay.ContractDate"] = g.ContractDate;
                newRow["TotalPay.ContractAmount"] = g.ContractAmount;
            ...
            var groupByBranchId = tblMaster.AsEnumerable().GroupBy(dr => new { BranchId = dr["BranchID"].ToString() })
                                   .Select(g => new
                                   {
                                       ...
                                       Values = g,
                                       SubCount = g.Count(),
                                       SubTotal = g.Sum(x => Numeral.AnyToDouble(x["ContractPayCost"])),
            ...
            customersTable.Columns["TotalPay.ContractAmount"].ExtendedProperties.Add("FormatNumber", "N0");
            ...
            customersListTable.Columns["TotalPay.ContractAmount"].ExtendedProperties.Add("FormatNumber", "N0");
