...
namespace GAM.Forms.Reports.Queries
{
    class Module_08
    {
        public static DataSet Fill(DataTable tblMaster, string[] dates, QueryProperties properties)
        {
            ...
            bands.Add(gvm.CreateBand("Debt", "مانده در مطالبات به تاریخ " + UDF.GetDateString(dates[0]), 195));

            #region گروه بندی مشتریان
            DataTable baseTable = new DataTable();
            baseTable = tblMaster.Clone();
            baseTable.Columns.Add(new DataColumn { ColumnName = "Date2_VS_Date1" });
            ...
            foreach (var g in GroupByContractId)
            {
                ...
                if (date2_Row == null)
                {
                    if (date1_Row != null)
                    {
                        ...
                        {
                            newRow[col.ColumnName] = date1_Row[col.ColumnName];
                        }
            ...
            if (baseTable.Rows.Count > 0)
            {
                ...
                customersTable.Columns.Add(new DataColumn { ColumnName = "Contract.ContractStatus", Caption = "وضعیت", DataType = Type.GetType("System.String") });
                ...
                customersTable.Columns.Add(new DataColumn { ColumnName = "Debt.Total", Caption = "جمع", DataType = Type.GetType("System.Double") });
                ...
                foreach (var g in SelectedCustomers)
                {
                    ...
                    newRow["Debt.Total"] = g.MandehAsl + g.MandehSood + g.MandehJarimeh + g.MandehHazineh;
            ...
            branchesTable.Columns.Add(new DataColumn { ColumnName = "Branches.CountOfContracts", Caption = "ت.قرارداد", DataType = Type.GetType("System.Double") });
            ...
            branchesTable.Columns.Add(new DataColumn { ColumnName = "Debt.Total", Caption = "جمع", DataType = Type.GetType("System.Double") });
            #endregion
            ...
            foreach (Branches.BranchInfo bi in Branches.GetAllBranchs())
            {
                ...
                if (groupByBranchId.ContainsKey(branchId))
                {
                    ...
                    newRow["Branches.CountOfContracts"] = row.CountOfContracts;
                    ...
                    newRow["Debt.Total"] = row.MandehAsl + row.MandehSood + row.MandehJarimeh + row.MandehHazineh;
                ...
                else
                {
                    ...
                    newRow["Branches.BranchName"] = bi.BranchName;
                    newRow["Branches.BranchDegree"] = bi.BranchDegree;
                    newRow["Branches.CountOfContracts"] = 0;
            ...
            domainsTable.Columns.Add(new DataColumn { ColumnName = "Domains.CountOfContracts", Caption = "ت.قرارداد", DataType = Type.GetType("System.Double") });
            ...
            domainsTable.Columns.Add(new DataColumn { ColumnName = "Debt.Total", Caption = "جمع", DataType = Type.GetType("System.Double") });
            ...
            foreach (Branches.DomainInfo di in Branches.GetDomains())
            {
                ...
                if (brRows != null)
                {
                    ...
                    newRow["Domains.CountOfContracts"] = brRows.Sum(x => Numeral.AnyToDouble(x["Branches.CountOfContracts"]));
                    ...
                    newRow["Debt.Total"] = brRows.Sum(x => Numeral.AnyToDouble(x["Debt.Total"]));
                ...
                else
                {
                    ...
                    newRow["Domains.DomainId"] = di.DomainId;
                    newRow["Domains.DomainName"] = di.DomainName;
                    newRow["Domains.CountOfContracts"] = 0;
                    newRow["Debt.MandehAsl"] = 0;
                    newRow["Debt.MandehSood"] = 0;
                    newRow["Debt.MandehJarimeh"] = 0;
                    newRow["Debt.MandehHazineh"] = 0;
            ...
            provinceTable.Columns.Add(new DataColumn { ColumnName = "Province.CountOfContracts", Caption = "ت.قرارداد", DataType = Type.GetType("System.Double") });
            ...
            provinceTable.Columns.Add(new DataColumn { ColumnName = "Debt.Total", Caption = "جمع", DataType = Type.GetType("System.Double") });
            ...
            foreach (Branches.ProvinceInfo pi in Branches.GetProvincesByZoneId(Users.MyZoneID))
            {
                ...
                if (doRows != null)
                {
                    ...
                    newRow["Province.CountOfContracts"] = doRows.Sum(x => Numeral.AnyToDouble(x["Domains.CountOfContracts"]));
                    ...
                    newRow["Debt.Total"] = doRows.Sum(x => Numeral.AnyToDouble(x["Debt.Total"])); provinceTable.Rows.Add(newRow);
                }
            }
            ...
            customersTable.Columns["Debt.Total"].ExtendedProperties.Add("FormatNumber", "N0");
            ...
            branchesTable.Columns["Branches.CountOfContracts"].ExtendedProperties.Add("FormatNumber", "N0");
            ...
            branchesTable.Columns["Debt.Total"].ExtendedProperties.Add("FormatNumber", "N0");
            ...
            domainsTable.Columns["Domains.CountOfContracts"].ExtendedProperties.Add("FormatNumber", "N0");
            ...
            domainsTable.Columns["Debt.Total"].ExtendedProperties.Add("FormatNumber", "N0");

            provinceTable.Columns["Province.ProvinceId"].ExtendedProperties["Visible"] = false;
            provinceTable.Columns["Province.CountOfContracts"].ExtendedProperties.Add("FormatNumber", "N0");
            ...
            provinceTable.Columns["Debt.Total"].ExtendedProperties.Add("FormatNumber", "N0");
            ...
            customersListTable.Columns["Debt.Total"].ExtendedProperties.Add("FormatNumber", "N0");
