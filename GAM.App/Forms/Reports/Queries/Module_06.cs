    ...
    class Module_06
    {
        public static DataSet Fill(DataTable tblMaster, string[] dates, QueryProperties properties)
        {
            ...
            if (baseTable.Rows.Count > 0)
            {
                ...
                var SelectedCustomers = baseTable.AsEnumerable().OrderByDescending(x => Numeral.AnyToDouble(x["MandehGheyreJari"])).GroupBy(dr => new { CustomerId = dr["CustomerID"].ToString(), BranchId = dr["BranchID"].ToString() })
                               .Select(g => new
                               {
            ...
            branchesTable.Columns.Add(new DataColumn { ColumnName = "Debt.CountOfCustomers", Caption = "تعداد", DataType = Type.GetType("System.Double") });
            ...
            foreach (Branches.BranchInfo bi in Branches.GetAllBranchs())
            {
                ...
                if (groupByBranchId.ContainsKey(branchId))
                {
                    ...
                    newRow["Debt.CountOfCustomers"] = row.CountOfCustomers;
                ...
                else
                {
                    ...
                    newRow["Branches.BranchName"] = bi.BranchName;
                    newRow["Branches.BranchDegree"] = bi.BranchDegree;
                    newRow["Debt.CountOfCustomers"] = 0;
            ...
            domainsTable.Columns.Add(new DataColumn { ColumnName = "Debt.CountOfCustomers", Caption = "تعداد", DataType = Type.GetType("System.Double") });
            ...
            foreach (Branches.DomainInfo di in Branches.GetDomains())
            {
                ...
                if (brRows != null)
                {
                    ...
                    newRow["Debt.CountOfCustomers"] = brRows.Sum(x => Numeral.AnyToDouble(x["Debt.CountOfCustomers"]));
            ...
            provinceTable.Columns.Add(new DataColumn { ColumnName = "Debt.CountOfCustomers", Caption = "تعداد", DataType = Type.GetType("System.Double") });
            ...
            foreach (Branches.ProvinceInfo pi in Branches.GetProvincesByZoneId(Users.MyZoneID))
            {
                ...
                if (doRows != null)
                {
                    ...
                    newRow["Debt.CountOfCustomers"] = doRows.Sum(x => Numeral.AnyToDouble(x["Debt.CountOfCustomers"]));
            ...
            branchesTable.Columns["Debt.CountOfCustomers"].ExtendedProperties.Add("FormatNumber", "N0");
            ...
            domainsTable.Columns["Debt.CountOfCustomers"].ExtendedProperties.Add("FormatNumber", "N0");
            ...
            provinceTable.Columns["Debt.CountOfCustomers"].ExtendedProperties.Add("FormatNumber", "N0");
