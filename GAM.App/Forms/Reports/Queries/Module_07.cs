...
namespace GAM.Forms.Reports.Queries
{
    class Module_07
    {
        public static DataSet Fill(DataTable tblMaster, string[] dates, QueryProperties properties)
        {
            ...
            bands.Add(gvm.CreateBand("SumOfDebt", "جمع مانده در مطالبات به تاریخ " + UDF.GetDateString(dates[0]), 240));
            ...
            customersTable.Columns.Add(new DataColumn { ColumnName = "SumOfDebt.MandehSarresidGozashteh", Caption = "اصل", DataType = Type.GetType("System.Double") });
            customersTable.Columns.Add(new DataColumn { ColumnName = "SumOfDebt.MandehMoavagh", Caption = "سود", DataType = Type.GetType("System.Double") });
            customersTable.Columns.Add(new DataColumn { ColumnName = "SumOfDebt.MandehMashkook", Caption = "جریمه", DataType = Type.GetType("System.Double") });
            customersTable.Columns.Add(new DataColumn { ColumnName = "SumOfDebt.Total", Caption = "جمع", DataType = Type.GetType("System.Double") });

            var GroupByCustomer = tblMaster.AsEnumerable().OrderByDescending(x => Numeral.AnyToDouble(x["MandehGheyreJari"])).GroupBy(dr => new { CustomerId = dr["CustomerID"].ToString(), BranchId = dr["BranchID"].ToString() })
                               .Select(g => new
                               {
                                   BranchInfo = Branches.GetBranchById(g.Key.BranchId, true),
                                   CustomerId = g.Key.CustomerId,
                                   CustomerName = g.First()["CustomerName"].ToString(),
                                   MandehSarresidGozashteh = g.Sum(x => Numeral.AnyToDouble(x["MandehSarresidGozashteh"])),
            ...
            {
                if (g.MandehSarresidGozashteh > 0)
                {
                    ...
                    newRow["SumOfDebt.MandehSarresidGozashteh"] = g.MandehSarresidGozashteh;
                    newRow["SumOfDebt.MandehMoavagh"] = g.MandehMoavagh;
                    newRow["SumOfDebt.MandehMashkook"] = g.MandehMashkook;
                    newRow["SumOfDebt.Total"] = g.MandehSarresidGozashteh + g.MandehMoavagh + g.MandehMashkook;
            ...
            branchesTable.Columns.Add(new DataColumn { ColumnName = "SumOfDebt.MandehSarresidGozashteh", Caption = "اصل", DataType = Type.GetType("System.Double") });
            branchesTable.Columns.Add(new DataColumn { ColumnName = "SumOfDebt.MandehMoavagh", Caption = "سود", DataType = Type.GetType("System.Double") });
            branchesTable.Columns.Add(new DataColumn { ColumnName = "SumOfDebt.MandehMashkook", Caption = "جریمه", DataType = Type.GetType("System.Double") });
            ...
            var groupByBranchId = customersTable.AsEnumerable().GroupBy(dr => new { BranchId = dr["Branches.BranchId"].ToString() })
                                   .Select(g => new
                                   {
                                       ...
                                       MandehSarresidGozashteh = g.Sum(x => Numeral.AnyToDouble(x["SumOfDebt.MandehSarresidGozashteh"])),
                                       MandehMoavagh = g.Sum(x => Numeral.AnyToDouble(x["SumOfDebt.MandehMoavagh"])),
                                       MandehMashkook = g.Sum(x => Numeral.AnyToDouble(x["SumOfDebt.MandehMashkook"])),
            ...
            foreach (Branches.BranchInfo bi in Branches.GetAllBranchs())
            {
                ...
                if (groupByBranchId.ContainsKey(branchId))
                {
                    ...
                    newRow["SumOfDebt.MandehSarresidGozashteh"] = row.MandehSarresidGozashteh;
                    newRow["SumOfDebt.MandehMoavagh"] = row.MandehMoavagh;
                    newRow["SumOfDebt.MandehMashkook"] = row.MandehMashkook;
                    newRow["SumOfDebt.Total"] = row.MandehSarresidGozashteh + row.MandehMoavagh + row.MandehMashkook;
                ...
                else
                {
                    ...
                    newRow["SumOfDebt.MandehSarresidGozashteh"] = 0;
                    newRow["SumOfDebt.MandehMoavagh"] = 0;
                    newRow["SumOfDebt.MandehMashkook"] = 0;
            ...
            domainsTable.Columns.Add(new DataColumn { ColumnName = "SumOfDebt.MandehSarresidGozashteh", Caption = "اصل", DataType = Type.GetType("System.Double") });
            domainsTable.Columns.Add(new DataColumn { ColumnName = "SumOfDebt.MandehMoavagh", Caption = "سود", DataType = Type.GetType("System.Double") });
            domainsTable.Columns.Add(new DataColumn { ColumnName = "SumOfDebt.MandehMashkook", Caption = "جریمه", DataType = Type.GetType("System.Double") });
            ...
            foreach (Branches.DomainInfo di in Branches.GetDomains())
            {
                ...
                if (brRows != null)
                {
                    ...
                    newRow["SumOfDebt.MandehSarresidGozashteh"] = brRows.Sum(x => Numeral.AnyToDouble(x["SumOfDebt.MandehSarresidGozashteh"]));
                    newRow["SumOfDebt.MandehMoavagh"] = brRows.Sum(x => Numeral.AnyToDouble(x["SumOfDebt.MandehMoavagh"]));
                    newRow["SumOfDebt.MandehMashkook"] = brRows.Sum(x => Numeral.AnyToDouble(x["SumOfDebt.MandehMashkook"]));
            ...
            provinceTable.Columns.Add(new DataColumn { ColumnName = "SumOfDebt.MandehSarresidGozashteh", Caption = "اصل", DataType = Type.GetType("System.Double") });
            provinceTable.Columns.Add(new DataColumn { ColumnName = "SumOfDebt.MandehMoavagh", Caption = "سود", DataType = Type.GetType("System.Double") });
            provinceTable.Columns.Add(new DataColumn { ColumnName = "SumOfDebt.MandehMashkook", Caption = "جریمه", DataType = Type.GetType("System.Double") });
            ...
            foreach (Branches.ProvinceInfo pi in Branches.GetProvincesByZoneId(Users.MyZoneID))
            {
                ...
                if (doRows != null)
                {
                    ...
                    newRow["SumOfDebt.MandehSarresidGozashteh"] = doRows.Sum(x => Numeral.AnyToDouble(x["SumOfDebt.MandehSarresidGozashteh"]));
                    newRow["SumOfDebt.MandehMoavagh"] = doRows.Sum(x => Numeral.AnyToDouble(x["SumOfDebt.MandehMoavagh"]));
                    newRow["SumOfDebt.MandehMashkook"] = doRows.Sum(x => Numeral.AnyToDouble(x["SumOfDebt.MandehMashkook"]));
            ...
            customersTable.Columns["SumOfDebt.MandehSarresidGozashteh"].ExtendedProperties.Add("FormatNumber", "N0");
            ...
            branchesTable.Columns["SumOfDebt.MandehSarresidGozashteh"].ExtendedProperties.Add("FormatNumber", "N0");
            branchesTable.Columns["SumOfDebt.MandehMoavagh"].ExtendedProperties.Add("FormatNumber", "N0");
            branchesTable.Columns["SumOfDebt.MandehMashkook"].ExtendedProperties.Add("FormatNumber", "N0");
            ...
            domainsTable.Columns["SumOfDebt.MandehSarresidGozashteh"].ExtendedProperties.Add("FormatNumber", "N0");
            domainsTable.Columns["SumOfDebt.MandehMoavagh"].ExtendedProperties.Add("FormatNumber", "N0");
            domainsTable.Columns["SumOfDebt.MandehMashkook"].ExtendedProperties.Add("FormatNumber", "N0");
            ...
            provinceTable.Columns["SumOfDebt.MandehSarresidGozashteh"].ExtendedProperties.Add("FormatNumber", "N0");
            provinceTable.Columns["SumOfDebt.MandehMoavagh"].ExtendedProperties.Add("FormatNumber", "N0");
            provinceTable.Columns["SumOfDebt.MandehMashkook"].ExtendedProperties.Add("FormatNumber", "N0");
            ...
            customersListTable.Columns["SumOfDebt.MandehSarresidGozashteh"].ExtendedProperties.Add("FormatNumber", "N0");
